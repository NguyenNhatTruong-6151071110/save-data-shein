...
def save(file_name: str, products: list):
    BASE_URL_TEMPLATE = 'https://s1.shein.com/SHEIN-{}-p-{}.html?src_module=All&src_identifier=on=PRODUCT_ITEMS_COMPONENT`cn=PRODUCT_ITEMS_COMPONENT_1`hz=0`ps=7_1_0`jc=itemPicking_003200800&src_tab_page_id=page_home1727898964238&mallCode=1'
    flattened_data_list = []
    ...
    for productData in products:
        ...
        flattened_data = {
            "goods_id": goods_id,
            "goods_sku": productData["goods_sn"],  # SKU
            ...
            "store_code": productData.get("storeInfo", {}).get("storeCode", "N/A"),
            "store_title": productData.get("storeInfo", {}).get("title", "N/A"),
            "store_logo": productData.get("storeInfo", {}).get("logo", "N/A"),
